...
const drawerSections = [
  ...
  },
  {
    section: 'Calls',
    items: [
      { path: '/app/calls/video', icon: Video, label: 'Video Calls', badge: null as string | null, color: 'text-blue-400' },
      { path: '/app/calls/audio', icon: Phone, label: 'Audio Calls', badge: null as string | null, color: 'text-green-400' },
    ],
  },
  {
    section: 'Explore',
    items: [
      ...
      { path: '/app/marketplace',   icon: ShoppingBag,   label: 'Marketplace',  badge: null as string | null, color: 'text-amber-500' },
